...
function UserDetail() {
    ...
    if (loading) {
        return (
            <h1>This website have been loading</h1>
        )
    }

    if (error) {
        return (
            <h1>This website have {error}</h1>
        )
    }
                        ...
                        <div className="col-lg-4">
                            <div className="card mb-4">
                                <div className="card-body text-center">
                                    ...
                                    <h5 className="my-3">{customer.CUSTOMER_NAME}</h5>
                                ...
                                <div className="card-body">
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9">
                                            <p className="text-muted mb-0">{customer.CUSTOMER_NAME}</p>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
                                        ...
                                        <div className="col-sm-9">
                                            <p className="text-muted mb-0">{customer.CUSTOMER_EMAIL}</p>
                                        </div>
                                    </div>
                                    <hr />
                                    <div className="row">
